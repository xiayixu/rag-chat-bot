...
class ElasticSearchBM25Retriever(BaseRetriever):
    ...
    @classmethod
    def create(
        cls, elasticsearch_url: str, index_name: str, k1: float = 1.2, b: float = 0.75
    ...
    def _get_relevant_documents(
        self, query: str,size = 15, *, run_manager: CallbackManagerForRetrieverRun
    ) -> List[Document]:
        ...
        for r in res["hits"]["hits"]:
            docs.append(Document(page_content=r["_source"]["page_content"], metadata=r["_source"].get("metadata", {})))
        return docs